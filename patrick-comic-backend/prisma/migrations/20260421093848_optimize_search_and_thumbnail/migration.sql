/*
  ...
  - You are about to drop the column `anhBia` on the `Truyen` table. All the data in the column will be lost.
...
INSERT INTO "new_Truyen" ("id", "luotXem", "moTa", "ngayCapNhat", "ngayTao", "slug", "tacGia", "tenKhongDau", "tenTruyen", "trangThai") SELECT "id", "luotXem", "moTa", "ngayCapNhat", "ngayTao", "slug", "tacGia", "tenKhongDau", "tenTruyen", "trangThai" FROM "Truyen";
DROP TABLE "Truyen";
